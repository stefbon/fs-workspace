...
#ifndef FS_WORKSPACE_SSH_SEND_TRANSPORT_H
#define FS_WORKSPACE_SSH_SEND_TRANSPORT_H


/* prototypes */

void send_disconnect_message(struct ssh_session_s *ssh_session, unsigned int reason);
