...
{
    struct ssh_string_s *kexinit_client=&session->keyexchange->keydata.kexinit_client;
    struct ssh_string_s *kexinit_server=&session->keyexchange->keydata.kexinit_server;
